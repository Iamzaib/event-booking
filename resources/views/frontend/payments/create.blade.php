                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.payments.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="amount_total" id="amount_total" value="{{ old('amount_total', '') }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="amount_balance" id="amount_balance" value="{{ old('amount_balance', '0') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Payment::PAYMENT_METHOD_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="payment_method_{{ $key }}" name="payment_method" value="{{ $key }}" {{ old('payment_method', 'CC') === (string) $key ? 'checked' : '' }} required>
