                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.testimonials.update", [$testimonial->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="review_text" id="review_text" value="{{ old('review_text', $testimonial->review_text) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ratings" id="ratings" value="{{ old('ratings', $testimonial->ratings) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="review_date" id="review_date" value="{{ old('review_date', $testimonial->review_date) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="featured" id="featured" value="1" {{ $testimonial->featured || old('featured', 0) === 1 ? 'checked' : '' }}>
