        ...
        <div class="col-md-12">
            @can('package_amenity_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.package-amenities.create') }}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-PackageAmenity">
                            <thead>
                                <tr>
                                    <th>
                                    ...
                                    <tr data-entry-id="{{ $packageAmenity->id }}">
                                        ...
                                        <td>
                                            @can('package_amenity_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.package-amenities.show', $packageAmenity->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('package_amenity_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.package-amenities.edit', $packageAmenity->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('package_amenity_delete')
                                                <form action="{{ route('frontend.package-amenities.destroy', $packageAmenity->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('package_amenity_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.package-amenities.massDestroy') }}",
