    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.event-tickets.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ticket_title" id="ticket_title" value="{{ old('ticket_title', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="ticket_date" id="ticket_date" value="{{ old('ticket_date') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="ticket_price" id="ticket_price" value="{{ old('ticket_price', '') }}" step="0.01" required>
