    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.booking-rooms.update", [$bookingRoom->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="room_booking_rate" id="room_booking_rate" value="{{ old('room_booking_rate', $bookingRoom->room_booking_rate) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="booking_from" id="booking_from" value="{{ old('booking_from', $bookingRoom->booking_from) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="booking_to" id="booking_to" value="{{ old('booking_to', $bookingRoom->booking_to) }}" required>
