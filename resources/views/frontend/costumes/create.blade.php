    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.costumes.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="costume_title">{{ trans('cruds.costume.fields.costume_title') }}</label>
                            <input class="form-control" type="text" name="costume_title" id="costume_title" value="{{ old('costume_title', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="costume_details" id="costume_details" value="{{ old('costume_details', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="costume_price" id="costume_price" value="{{ old('costume_price', '') }}" step="0.01" required>
