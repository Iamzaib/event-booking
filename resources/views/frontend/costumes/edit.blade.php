    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.costumes.update", [$costume->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="costume_title">{{ trans('cruds.costume.fields.costume_title') }}</label>
                            <input class="form-control" type="text" name="costume_title" id="costume_title" value="{{ old('costume_title', $costume->costume_title) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="costume_details" id="costume_details" value="{{ old('costume_details', $costume->costume_details) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="costume_price" id="costume_price" value="{{ old('costume_price', $costume->costume_price) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Costume::STATUS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', $costume->status) === (string) $key ? 'checked' : '' }}>
