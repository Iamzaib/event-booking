                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.settings.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="setting_key" id="setting_key" value="{{ old('setting_key', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="setting_value" id="setting_value" value="{{ old('setting_value', '') }}" required>
