...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.event-addons.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="addon_title">{{ trans('cruds.eventAddon.fields.addon_title') }}</label>
                <input class="form-control {{ $errors->has('addon_title') ? 'is-invalid' : '' }}" type="text" name="addon_title" id="addon_title" value="{{ old('addon_title', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('addon_details') ? 'is-invalid' : '' }}" type="text" name="addon_details" id="addon_details" value="{{ old('addon_details', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('addon_price') ? 'is-invalid' : '' }}" type="number" name="addon_price" id="addon_price" value="{{ old('addon_price', '') }}" step="0.01" required>
