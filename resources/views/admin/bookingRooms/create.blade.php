...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.booking-rooms.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('room_booking_rate') ? 'is-invalid' : '' }}" type="number" name="room_booking_rate" id="room_booking_rate" value="{{ old('room_booking_rate', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('booking_from') ? 'is-invalid' : '' }}" type="text" name="booking_from" id="booking_from" value="{{ old('booking_from') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('booking_to') ? 'is-invalid' : '' }}" type="text" name="booking_to" id="booking_to" value="{{ old('booking_to') }}" required>
