                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                ...
                                @can('blog_category_create')
                                    <a class="btn btn-primary ms-2" href="{{ route('admin.blog-categories.create') }}">
                                    ...
                                    <div class="col-auto">
                                        @if(request('category')||request('search'))
                                            <div class="d-inline-block">
                                                <a type="button" class="btn btn-danger btn-sm w-100 " href="{{route('admin.blog-categories.index')}}">
...
{{--                                        </div>--}}
                                        ...
                                        <tr data-entry-id="{{ $blogCategory->id }}">
                                            <td>
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input list-checkbox" onclick="total_checkboxes()" name="list-checkbox" id="listCheckbox-{{ $blogCategory->id }}" value="{{ $blogCategory->id }}" type="checkbox">
                                                    <label class="form-check-label" for="listCheckbox-{{ $blogCategory->id }}"></label>
                                                </div>

                                            </td>
                                            <td>
                                                <a class=" text-reset" href="{{ route('admin.blog-categories.show', $blogCategory->id) }}">
                                                    {{ $blogCategory->name ?? '' }}</a>
                                            </td>
                                            <td>
                                                {{ $blogCategory->slug ?? '' }}
                                            ...
                                            <td class="text-end"> <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        @can('blog_category_show')
                                                            <a class="dropdown-item" href="{{ route('admin.blog-categories.show', $blogCategory->id) }}">
                                                                {{ trans('global.view') }}
                                                            </a>
                                                        @endcan

                                                        @can('blog_category_edit')
                                                            <a class="dropdown-item" href="{{ route('admin.blog-categories.edit', $blogCategory->id) }}">
                                                                {{ trans('global.edit') }}
                                                            </a>
                                                        @endcan
                            ...
                            {{$blogCategories->appends(request()->merge(['sort' => $sort,'per_page'=>$per_page])->all())->links()}}
...
@section('scripts')
    <script>
        var route="{{ route('admin.blog-categories.massDestroy') }}",export_route='';{{--route('admin.blog-categories.export')--}}
    </script>
    @parent
@endsection
