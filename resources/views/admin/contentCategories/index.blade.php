                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                ...
                                @can('content_category_create')
                                    <a class="btn btn-primary ms-2" href="{{ route('admin.content-categories.create') }}">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="contactsListPane" role="tabpanel" aria-labelledby="contactsListTab">
                        ...
                        <div class="card"  id="contactsList">
                            <div class="card-header no-print">
                                <div class="row align-items-center">
                                    <div class="col">
                                        ...
                                        <!-- Form -->
                                        <form action="{{ route('admin.content-categories.index') }}">
                                    ...
                                    <div class="col-auto">
                                        @if(request('category')||request('search'))
                                            <div class="d-inline-block">
                                                <a type="button" class="btn btn-danger btn-sm w-100 " href="{{route('admin.content-categories.index')}}">
                                        ...
                                        <tr data-entry-id="{{ $contentCategory->id }}">
                                            <td>
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input list-checkbox" onclick="total_checkboxes()" name="list-checkbox" id="listCheckbox-{{ $contentCategory->id }}" value="{{ $contentCategory->id }}" type="checkbox">
                                                    <label class="form-check-label" for="listCheckbox-{{ $contentCategory->id }}"></label>
                                                </div>

                                            </td>
                                            <td>
                                                <a class=" text-reset" href="{{ route('admin.content-categories.show', $contentCategory->id) }}">
                                            ...
                                            <td class="text-end"> <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        @can('content_category_show')
                                                            <a class="dropdown-item" href="{{ route('admin.content-categories.show', $contentCategory->id) }}">
                                                                {{ trans('global.view') }}
                                                            </a>
                                                        @endcan

                                                        @can('content_category_edit')
                                                            <a class="dropdown-item" href="{{ route('admin.content-categories.edit', $contentCategory->id) }}">
                                                                {{ trans('global.edit') }}
                                                            </a>
                                                        @endcan
                            ...
                            {{$contentCategories->appends(request()->merge(['sort' => $sort,'per_page'=>$per_page])->all())->links()}}
...
@section('scripts')
    <script>
        var route="{{ route('admin.content-categories.massDestroy') }}",export_route='';{{--route('admin.content-categories.export')--}}
    </script>
    @parent
@endsection
