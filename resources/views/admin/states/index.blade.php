                    ...
                    <div class="header-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                ...
                                @can('state_create')
                                    <a class="btn btn-primary ms-2" href="{{ route('admin.states.create') }}">
                                    ...
                                    <div class="col-auto">
                                        @if(request('country')||request('search'))
                                            <div class="d-inline-block">
                                                <a type="button" class="btn btn-danger btn-sm w-100 " href="{{route('admin.states.index')}}">
                                                    <i class="bi-download me-2"></i> Reset Search & Filters
                                                </a>
                                            </div>
                                    @endif
                                    {{--                                    <div class="dropdown d-inline-block">--}}
                                    {{--                                        <button type="button" class="btn btn-white btn-sm dropdown-toggle w-100" id="statesExportDropdown" data-bs-toggle="dropdown" aria-expanded="true">--}}
                                    {{--                                            <i class="bi-download me-2"></i> Export--}}
                                    {{--                                        </button>--}}

                                    {{--                                        <div class="dropdown-menu dropdown-menu-sm-end" aria-labelledby="statesExportDropdown" style="position: absolute; inset: auto 0px 0px auto; margin: 0px; transform: translate3d(-0.483337px, -39.2px, 0px);" data-popper-placement="top-end" data-popper-reference-hidden="">--}}
...
{{--                                                        </div>--}}
                            ...
                            <div class="table-responsive overflow-visible print">
                                <table class="table table-sm table-hover table-nowrap card-table" id="data-table">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <a class="list-sort text-muted"  href="{{request()->fullUrlWithQuery(['sort' => 'state_name-'.$sort_type,'sorting'=>1])}}">{{ trans('cruds.state.fields.state_name') }}</a>
                                        </th>
                                        <th>
                                            <a class="list-sort text-muted"  href="{{request()->fullUrlWithQuery(['sort' => 'country-'.$sort_type,'sorting'=>1])}}"> {{ trans('cruds.state.fields.state') }}</a>
                                        </th>
                                        <th>
                                            Actions
                                        </th>
                                        ...
                                        <tr data-entry-id="{{ $state->id }}">
                                            <td>
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input list-checkbox" name="list-checkbox" onclick="total_checkboxes()" id="listCheckbox-{{ $state->id }}" value="{{ $state->id }}" type="checkbox">
                                                    <label class="form-check-label" for="listCheckbox-{{ $state->id }}"></label>
                                                </div>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        @can('state_show')
                                                            <a class="dropdown-item" href="{{ route('admin.states.show', $state->id) }}">
                                                                {{ trans('global.view') }}
                                                            </a>
                                                        @endcan

                                                        @can('state_edit')
                                                            <a class="dropdown-item" href="{{ route('admin.states.edit', $state->id) }}">
                                                                {{ trans('global.edit') }}
                                                            </a>
                                                        @endcan
                            ...
                            {{$states->appends(request()->merge(['sort' => $sort,'per_page'=>$per_page])->all())->links()}}
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label text-white" for="listAlertCheckbox">
                                                    <span class="list-alert-count" id="list-alert-count">0</span> State(s)
                                                </label>
                                            </div>
...
@endsection
@section('scripts')
    <script>var route= '{{ route('admin.states.massDestroy') }}',export_route='';</script>
    @parent
