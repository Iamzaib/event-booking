...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.costume.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.costumes.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('costume_title') ? 'is-invalid' : '' }}" type="text" name="costume_title" id="costume_title" value="{{ old('costume_title', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('costume_details') ? 'is-invalid' : '' }}" type="text" name="costume_details" id="costume_details" value="{{ old('costume_details', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('costume_price') ? 'is-invalid' : '' }}" type="number" name="costume_price" id="costume_price" value="{{ old('costume_price', '') }}" step="0.01" required>
