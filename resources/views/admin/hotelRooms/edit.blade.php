    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.hotel-rooms.update", [$hotelRoom->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discount_price') ? 'is-invalid' : '' }}" type="number" name="discount_price" id="discount_price" value="{{ old('discount_price',$hotelRoom->discount_price ) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('room_capacity') ? 'is-invalid' : '' }}" type="text" name="room_capacity" id="room_capacity" value="{{ old('room_capacity', $hotelRoom->room_capacity) }}" required>
