                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                ...
                                @can('testimonial_create')
                                    <a class="btn btn-primary ms-2" href="{{ route('admin.testimonials.create') }}">
                            ...
                            <div class="card-header no-print">
                                <div class="row align-items-center">
                                    <div class="col">
                                        ...
                                        <!-- Form -->
                                        <form action="{{ route('admin.testimonials.index') }}">
                                    ...
                                    <div class="col-auto">
                                        @if(request('category')||request('search'))
                                            <div class="d-inline-block">
                                                <a type="button" class="btn btn-danger btn-sm w-100 " href="{{route('admin.testimonials.index')}}">
                                        ...
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <form class="dropdown-menu dropdown-menu-end dropdown-menu-card " style="min-width: 370px">
                                                ...
                                                @if(request('user')||request('search'))
                                                    <!-- Link -->
                                                                ...
                                                                <div class="col-auto">
                                                                    ...
                                                                    <select class="form-select form-select-sm form-control" name="category" >
                                                                        ...
                                                                        @foreach($filters['users'] as $id => $val)
                                                                            <option value="{{$id}}" {{request('user')&&request('user')==$id?'selected':''}}>{{$val}}</option>
                                                                        @endforeach
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-auto">
                                                                    ...
                                                                    <select class="form-select form-select-sm" name="event" >
                                                                        {{--                                                                        <option value="*" selected>Any</option>--}}
                                                                        @foreach($filters['events'] as $id => $val)
                                                                            <option value="{{$id}}"  {{request('event')&&request('event')==$id?'selected':''}}>{{$val}}</option>
                                                                        @endforeach
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-auto">
                                                                    ...
                                                                    @for($star=1;$star<=5;$star++)
                                                                            <option value="{{$star}}"  {{request('rating')&&request('rating')==$star?'selected':''}}>{{$star}} star</option>
                                                                        @endfor
                                                                    </select>
                            ...
                            <div class="table-responsive overflow-visible print">
                                <table class="table table-sm table-hover table-nowrap card-table" id="data-table">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <a class="list-sort text-muted"  href="{{request()->fullUrlWithQuery(['sort' => 'ratings-'.$sort_type,'sorting'=>1])}}">
                                                {{ trans('cruds.testimonial.fields.ratings') }}</a>
                                        </th>
                                        <th>
                                            <a class="list-sort text-muted"  href="{{request()->fullUrlWithQuery(['sort' => 'user-'.$sort_type,'sorting'=>1])}}">
                                                {{ trans('cruds.testimonial.fields.user') }}</a>
                                        </th>
                                        <th>
                                            <a class="list-sort text-muted"  href="{{request()->fullUrlWithQuery(['sort' => 'event-'.$sort_type,'sorting'=>1])}}">
                                                {{ trans('cruds.testimonial.fields.event_trip_booking') }}
                                            </a>
                                        </th>
                                        <th>
                                            <a class="list-sort text-muted"  href="{{request()->fullUrlWithQuery(['sort' => 'review_date-'.$sort_type,'sorting'=>1])}}">
                                        ...
                                        <tr data-entry-id="{{ $testimonial->id }}">
                                            <td>
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input list-checkbox" onclick="total_checkboxes()" name="list-checkbox" id="listCheckbox-{{ $testimonial->id }}" value="{{ $testimonial->id }}" type="checkbox">
                                                    <label class="form-check-label" for="listCheckbox-{{ $testimonial->id }}"></label>
                                                </div>

                                            </td>
                                            <td>
{{--                                                <a class=" text-reset" href="{{ route('admin.testimonials.show', $testimonial->id) }}">--}}
                                                    <span class="white-spaces-normal">{{ \Illuminate\Support\Str::limit(($testimonial->review_text ?? ''), 70) }}</span>
{{--                                                </a>--}}
                                            </td>
                                            <td>
                                                {{ $testimonial->ratings ?? '' }}
                                            ...
                                            <td class="text-end"> <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        @can('testimonial_show')
                                                            <a class="dropdown-item" href="{{ route('admin.testimonials.show', $testimonial->id) }}">
                                                                {{ trans('global.view') }}
                                                            </a>
                                                        @endcan
                            ...
                            {{$testimonials->appends(request()->merge(['sort' => $sort,'per_page'=>$per_page])->all())->links()}}
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label text-white" for="listAlertCheckbox">
                                                    <span class="list-alert-count" id="list-alert-count">0</span>  Testimonial/Review(s)
                                                </label>
                                            </div>
...
@section('scripts')
    <script>
        var route="{{ route('admin.testimonials.massDestroy') }}",export_route='{{route('admin.testimonials.export')}}';
    </script>
    @parent
@endsection
