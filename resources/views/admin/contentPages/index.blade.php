                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                ...
                                @can('content_page_create')
                                    <a class="btn btn-primary ms-2" href="{{ route('admin.content-pages.create') }}">
                            ...
                            <div class="card-header no-print">
                                <div class="row align-items-center">
                                    <div class="col">
                                        ...
                                        <!-- Form -->
                                        <form action="{{ route('admin.content-pages.index') }}">
                                    ...
                                    <div class="col-auto">
                                        @if(request('category')||request('search'))
                                            <div class="d-inline-block">
                                                <a type="button" class="btn btn-danger btn-sm w-100 " href="{{route('admin.content-pages.index')}}">
...
{{--                                                        </div>--}}
                                        ...
                                        <tr data-entry-id="{{ $contentPage->id }}">
                                            <td>
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input list-checkbox" onclick="total_checkboxes()" name="list-checkbox" id="listCheckbox-{{ $contentPage->id }}" value="{{ $contentPage->id }}" type="checkbox">
                                                    <label class="form-check-label" for="listCheckbox-{{ $contentPage->id }}"></label>
                                                </div>

                                            </td>
                                            <td>
                                                <a class=" text-reset" href="{{ route('admin.content-pages.show', $contentPage->id) }}">
                                                    {{ $contentPage->title ?? '' }}</a>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-end"> <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        @can('content_page_show')
                                                            <a class="dropdown-item" href="{{ route('admin.content-pages.show', $contentPage->id) }}">
                                                                {{ trans('global.view') }}
                                                            </a>
                                                        @endcan

                                                        @can('content_page_edit')
                                                            <a class="dropdown-item" href="{{ route('admin.content-pages.edit', $contentPage->id) }}">
                                                                {{ trans('global.edit') }}
                                                            </a>
                                                        @endcan
                            ...
                            {{$contentPages->appends(request()->merge(['sort' => $sort,'per_page'=>$per_page])->all())->links()}}
...
@section('scripts')
    <script>
        var route="{{ route('admin.content-pages.massDestroy') }}",export_route='{{route('admin.content-pages.export')}}';
    </script>
    @parent
@endsection
