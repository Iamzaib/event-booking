    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.event-tickets.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ticket_title') ? 'is-invalid' : '' }}" type="text" name="ticket_title" id="ticket_title" value="{{ old('ticket_title', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('ticket_date') ? 'is-invalid' : '' }}" type="text" name="ticket_date" id="ticket_date" value="{{ old('ticket_date') }}" required>
