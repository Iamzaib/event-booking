...
.choosepaymemyrad input[type="radio"] + label p {
   ...
   color: #4a00e0;
   background: rgba(212, 192, 253, 0.4);
}
.choosepaymemyrad input[type="radio"]:checked+label h3 b{
color: #000 !important;
}
.choosepaymemyrad input[type="radio"]:checked+label h3{
color: #000 !important;
}
.choosepaymemyrad input[type="radio"]:checked+label p{
color: #000 !important;
}
.choosepaymemyrad input[type="radio"]:checked+label h3 b sup{

}
.choosepaymemyrad input[type="radio"] + label h3 b{
...
select.form-control.room {
    -webkit-appearance: listbox !important;
}
.choosepaymemyrad.deposit_button {
position: relative;
	}

	.choosepaymemyrad.deposit_button .boxchlabl {
    border-bottom: none;
}
	.choosepaymemyrad.deposit_button .boxchlabl h3{
        width: 100%;
    font-size: 15px !important;
    color: #545455;
    margin-bottom: 6px !important;
}
.choosepaymemyrad.deposit_button .boxchlabl h3 b{
        width: 100%;
    font-size: 17px !important;
    color: #545455;
    margin-bottom: 0px !important;
}
	.choosepaymemyrad.deposit_button .boxchlabl h6{
    color: #222222;
		/* font-family:IBMPlexSans-SemiBold !important; */
		font-size: 13px;
		font-weight: 500;
}
.choosepaymemyrad.deposit_button .boxchlabl h6 span{
    font-size: 17px;
    font-family: ClashDisplay-Medium !important;
}
	.choosepaymemyrad.deposit_button .boxchlabl p{
        font-weight: 100;
		width: 100%;
}
	.choosepaymemyrad.deposit_button input[type="radio"]{
		display: block;
    position: absolute;
    left: 12px;
    z-index: 9999;
    ...
    .choosepaymemyrad.deposit_button label{
...
{{--                        <img src="{{asset('assets/front/img/tour2.png')}}" class="tourimg1ct" />--}}
                        ...
                        <div class="custrip2" style="border: none;">
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    <h3 class="textheadcusttrip">How many persons are you booking for?</h3>
...
{{--                                        </form>--}}
                        ...
                        <div class="">
                            ...
                            <div class="row mt-3 ">
                                <div class="col-md-12">
                                    <h5 class="textheadcusttrip">Choose Your Dates</h5>
                                </div>
                                        ...
                                        <div class="choosepaymemyrad">
                                            ...
                                            <label for="range{{$date_range->id}}">
                                                <div class="boxchlabl border0 ">
                                                    ...
                                                    <h3 class="marbot0 mt-2 text-right" style="text-align: right"><b><sup style="font-size: 14px;top: 0px;">Starting From</sup>&nbsp;{{display_currency($date_range->range_price)}}</b></h3>
...
<!--														<img src="{{asset('assets/front/img/calendar2.svg')}}"/>-->
                                                    @php
                                                        $start = new DateTime($date_range->range_start);
                                                        $end = new DateTime($date_range->range_end);
                        ...
                        <div class="custrip2">
                            <h3 class="textheadcusttrip bordertpnew">Choose your Accommodation</h3>
                            <p style="font-size: 15px;">Are you sharing a room with more than one persons? If yes, you roommates are required to book and pay at the same time</p>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card newmaincard">
                                        <div class="card-header">
                                            <div class="row">
                                                <div class="col-6"><strong>No Accommodation</strong></div>
                                                <div class="col-6">No. of Person</div>
                                            </div>

                                        </div>
                                        <div class="card-body newcardbd mbpb20">
                                            @foreach($no_accommodation->rooms as $room)
                                                <div class="row mt-3 pl-3 pr-3"  style="margin: 0px !important;">
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <select name="room_persons[{{$room->id}}]" class="form-select room" data-id="{{$room->id}}" data-roomprice="{{$room->room_price}}" id="">
                                ...
                                @foreach($trip->hotels as $hotel)
                                    ...
                                    <div class="col-md-12">
                                        <div class="card newmaincard">
                                            <div class="card-header">
                                                <div class="row">
                                                    <div class="col-6">{{$hotel->hotel_name}}</div>
                                                    <div class="col-6">No. of Person</div>
                                                </div>
...
{{--                                                <div class="row mt-3 pl-3 pr-3" style="margin: 0px !important;">--}}
{{--                                                    <div class="col-12 col-md-6">--}}
{{--                                                        <h6>*No Accommodation</h6>--}}
{{--                                                        <p>--}}
{{--                                                            Number of travellers in your group if you have your own accommodation.--}}
{{--                                                        </p>--}}
{{--                                                    </div>--}}
{{--                                                    <div class="col-12 col-md-6">--}}
{{--                                                        <select name="room_persons[0]" class="form-select room" data-roomprice="0" data-id="0" onchange="" id="">--}}
{{--                                                            <option value="0">--Please Select--</option>--}}
...
{{--                                                    @dd($room->pricing)--}}
                                                    ...
                                                    <div class="row mt-3 pl-3 pr-3" style="margin: 0px !important;">
                                                        ...
                                                        <div class="col-12 col-md-6">
                                                            <select name="room_persons[{{$room->id}}]" class="form-select room" data-id="{{$room->id}}" data-roomprice="{{$room->room_price}}" id="">
                                                                <option value="0">--Please Select--</option>
                                                                @for($i=($room->pricing()->orderBy('for_travelers', 'asc')->first()->for_travelers);$i<=($room->room_capacity>$travelers?$travelers:$room->room_capacity);$i++)
                                                                    <option value="{{$i}}">{{$i}} Person(s)</option>
                                                                @endfor
                                                            </select>
                                                        </div>
                        ...
                        @for($t=1;$t<=$travelers;$t++)
                            @if(count($trip->costumes)>0)
                                <div class="custrip2 newpdt8 mbpb20">
                                    <div class="row align-items-center">
                                        <div class="col-md-6">
                                            <h3 class="textheadcusttrip">Choose your Costume: Traveler {{$t}} </h3>
                                            <p>You will be provided costume options when become available</p>
                                        </div>
                                        <div class="col-md-6">
                                        <!-- <div class="kravemd marbotmd">
                            ...
                            @if(count($trip->tickets)>0)
                                <div class="custrip2 newpdt8">
                                    <h3 class="textheadcusttrip">Choose your Event Tickets: Traveler {{$t}}</h3>
                            ...
                            @if(count($trip->addons)>0)
                                <div class="custrip2">
                                    <h3 class="textheadcusttrip">Choose any Additional Services : Traveler {{$t}}</h3>
                                    ...
                                    <div class="row">
                                        @foreach($trip->addons as $addon)
                                            <div class="col-md-4">
                                                <div class="choosepaymemyrad">
                                                    <input type="checkbox" id="addon_{{$t}}{{$addon->id}}" class="addons" name="addon[{{$t}}][{{$addon->id}}]" {{old('addon.'.$t.'.'.$addon->id)&&old('addon.'.$t.'.'.$addon->id)==$addon->id?'checked':''}} value="{{$addon->id}}" data-traveler="{{$t}}" data-addonprice="{{$addon->addon_price}}">
                                                    <label for="addon_{{$t}}{{$addon->id}}" class="text-center">
                            ...
                            @endif
                        @endfor
                        <div class="custrip2" style="padding-bottom: 10px;">
                            <div class="row">
                                <h3 class="textheadcusttrip">Choose a payment option.</h3>
								<p>Carnival Utopia provides you with the most flexible payment plan, making it super easy and affordable to book your carnival experience.</p>

                                <div class="col-md-12">
                                    <div class="choosepaymemyrad deposit_button ">
...
<!--                                                <h3><b id="install">{{display_currency($low_deposit)}} Deposit + {{display_currency($low_installment)}} for {{TOTAL_INSTALLMENTS}} Months</b></h3>-->
                        ...
                        <div class="container no-gutters" style="padding: 0px !important;">
                            <div class="row no-gutters">
                                <div class="col-md-12">
                                    <h4 class="textheadcusttrip" style="margin: 20px 0;">Travel Details</h4>
                                    <p><img src="{{asset('assets/front/img/info-circle2.svg')}}"> The traveller information should match their passport where applicable.</p>
                                </div>
                                @for($t=1;$t<=$travelers;$t++)
                                    <div class="col-md-12">
                                        <div class="card mpb0">
                                            <div class="card-header padmbl" style="border: 0px solid !important;">
                                                <h6 class="travelrh6">Traveler {{$t}}</h6>
                                            </div>
                                            <div class="card-body p-3 mpb0 padmbl" style="padding-top:0px !important;">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="prel">
                                                                <input type="text" class="inputText" placeholder="First name" required value="{{old('first_name.'.$t)}}" name="first_name[{{$t}}]" />
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="prel">
                                                                <input type="text" class="inputText" placeholder="Last name" required value="{{old('last_name.'.$t)}}" name="last_name[{{$t}}]" />
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            {{--                                                        <div class="prel">--}}
                                                            <label for="Notes{{$t}}">Add Notes (optional)</label>
                                                            <textarea type="text" class="inputText " name="notes[{{$t}}]" style="height: auto" id="Notes{{$t}}" placeholder="Your notes here" rows="4">{{old('notes.'.$t)}}</textarea>
                         ...
                         <div class=" ">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="card">
                                                    <div class="card-header padmbl" style="    border: 0px solid !important;">
                                                        <h6 class="textheadcusttrip bordertpnew" style="margin: 0px 0 !important;">Pay By Card</h6>
                                                    </div>
...
{{--                                                                @dd($paymentmethod)--}}
                                    ...
                                    <div class="col-12 mb-4" style="" >
                                                <h3 class="textheadcusttrip ">Terms And Conditions.</h3>
                                                <div>
                                                    <label for="terms" class="form-check-label"><input type="checkbox" class="form-check-input" name="terms[]" id="terms">
                                                        &nbsp;By selecting the button below, I agree to Carnival Utopia's <a class="tacatg" href="#">customer terms and conditions</a>, <a class="tacatg" href="#">refund policy</a>, <a class="tacatg" href="#">customer participation agreement</a>, and <a class="tacatg" href="#">code of conduct</a>.</label>
                                                    <label for="terms" class="form-check-label"><input type="checkbox" class="form-check-input" name="terms[]" id="terms">
                                                    &nbsp;I also agree to the <a class="tacatg" href="#">updated Terms of Service</a>, <a class="tacatg" href="#">Payments Terms of Service</a>, and I acknowledge the <a class="tacatg" href="{{route('page_view',['page_name'=>'Privacy-Policy','pID'=>2])}}">Privacy Policy</a>.</label>
...
{{--                        </div>--}}
                    ...
                    <div class="col-md-4">
                        <div class="pricech1 pricechb1">
                            <h2 class=""><img src="{{asset('assets/front/img/trip-summary.svg')}}" style="width: 25px;">Trip Summary</h2>
...
{{--                                            <h6 class="text-black" >Trip Cost</h6>--}}
                                            <p id="room_{{$tr}}" class="mb-0"></p>
                                            <p id="costume_{{$tr}}" class="mb-0"></p>
                                            <p id="tickets_{{$tr}}" class="mb-0"></p>
                                            <p id="addons_{{$tr}}" class="mb-0"></p>
...
{{--                                </div>--}}
                            ...
                            <div id="Installment" class="mainmaxprice">
                                <span style="font-size: 17px;">Installment(s) Details</span>
...
var travelers_total=[],costume_trvlr=[],ticket_trvlr=[],room_trvlr=[],addon_trvlr=[],costumes_trvlr=[];
        ...
        $(function (){
            ...
            $('.costume').change(function () {
                var trvlr = $(this).data('traveler');
                 var costume_id = parseInt($(this).val());
                 // if()
                        if(typeof costume_id !== 'undefined'&&costume_id>0){
                            costumes_trvlr[trvlr]=costume_id;
                            costume_total += parseFloat(costumes[costume_id]);
                            costume_trvlr[trvlr]=parseFloat(costumes[costume_id]);
                        }else{
                            if(costumes_trvlr[trvlr]>0){
                                costume_total -= parseFloat(costumes[costume_id]);
            ...
            $('.addons').change(function () {
                ...
                //     console.log($(this).val());
                    ...
                    let id_found = false;
                if (typeof addons_added[trvlr] === 'undefined'){
                    addons_added[trvlr]=[];
                }
                    for (var v = 0; v < addons_added[trvlr].length; v++) {
                        if (addons_added[trvlr][v] === addon_id) {
                            id_found = true;
                        }
                    }
                    if (id_found === false&&this.checked) {
                        addons_added[trvlr].push(addon_id);
                        addons_total += parseFloat(addons[addon_id]);
                        addon_trvlr[trvlr] += parseFloat(addons[addon_id]);
                        ...
                        for (var i = 0; i < addons_added.length; i++) {
                            if (addons_added[trvlr][i] === addon_id) {
                                addons_added[trvlr].splice(addons_added[trvlr].indexOf(addon_id), 1);
                                addons_total -= parseFloat(addons[addon_id]);
                                addon_trvlr[trvlr] -= parseFloat(addons[addon_id]);
                                $('#addon_subtotal'+addon_id).remove();
                            }
                        }
                        if(addons_added[trvlr].length<=0){
                            subprices_div.find('#addons').hide();
                        }
                    }
                    calculate_total();
           ...
           @if(count($trip->tickets)>0)
                    $('.ticket').change(function () {
                        ...
                        // console.log(ticket_trvlr[trvlr]);
                        calculate_total();
                    });
                    @endif
...
*/
        ...
        function calculate_total(){
            ...
            console.log(room_range_pricing);
            for(var tr=1;tr<=total_travelers;tr++){
                var ttl=0;
                if(room_trvlr[tr]>0){
                    ttl+=parseFloat(room_range_pricing[date_range_id][room_trvlr[tr]]);
                    total+=parseFloat(room_range_pricing[date_range_id][room_trvlr[tr]]);
                    $('#room_'+tr).html(rooms_titles[room_trvlr[tr]]);
                    console.log(parseFloat(room_range_pricing[date_range_id][room_trvlr[tr]]));
                }
                // console.log(room_trvlr);
                if(costume_trvlr[tr]>0){
                    ttl+=parseFloat(costume_trvlr[tr]);
                    $('#costume_'+tr).html(costumes_titles[costumes_trvlr[tr]]);
                }
                if(ticket_trvlr[tr]>0){
                    ttl+=parseFloat(ticket_trvlr[tr]);
                    var trvler_tickets='';
                    for (var t = 0; t < tickets_added[tr].length; t++) {
                        trvler_tickets+=tickets_titles[tickets_added[tr][t]]+"<br>";
                    }
                    $('#tickets_'+tr).html(trvler_tickets);
                }
                if(addon_trvlr[tr]>0){
                    ttl+=parseFloat(addon_trvlr[tr]);
                    var trvler_addon='';
                    for (var i = 0; i < addons_added[tr].length; i++) {
                        trvler_addon+=addons_titles[addons_added[tr][i]]+"<br>";
                    }
                    $('#addons_'+tr).html(trvler_addon);
                }
