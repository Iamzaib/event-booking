        ...
        <div class="container margin_60_35" style="transform: none;">
            ...
            {{--   <aside class="col-lg-3" id="sidebar"
                   ...
                   <div class="theiaStickySidebar"
                        style="padding-top: 0px; padding-bottom: 1px; position: static; transform: none; top: 0px; left: 87px;">
                       {{--                    <div id="filters_col">
                           ...
                           <div class="collapse" id="collapseFilters">
                               <div class="filter_type">
                                   ...
                                   <ul>
                                       <li>
                                           <label class="chbox2q2">New Year 's consent 2021
                                               <input type="checkbox">
                                               <span class="checkmark"></span>
                                           </label>
                                       </li>
                                       <li>
                                           <label class="chbox2q2">Bus
                                               <input type="checkbox">
                                               <span class="checkmark"></span>
                                           </label>
                                       </li>
                                       <li>
                                           <label class="chbox2q2">Rest in Lithuania
                                               <input type="checkbox">
                                               <span class="checkmark"></span>
                                           </label>
                                       </li>
                                       <li>
                                           <label class="chbox2q2">Last minute
                                               <input type="checkbox">
                                               <span class="checkmark"></span>
                                           </label>
                                       </li>
                                       <li>
                                           <label class="chbox2q2">Recreation
                                               <input type="checkbox">
                                               <span class="checkmark"></span>
                                           </label>
                                       </li>
                               ...
                               <div class="filter_type">
                                   ...
                                   <ul>
                                       <li>
                                           <label class="chbox2q2">Kaunas Airport
                                               <input type="checkbox">
                                               <span class="checkmark"></span>
                                           </label>
                                       </li>
                                       <li>
                                           <label class="chbox2q2">Vilnius airport
                                               <input type="checkbox">
                                               <span class="checkmark"></span>
                                           </label>
                                       </li>
                                       <li>
                                           <label class="chbox2q2">London airports
                                               <input type="checkbox">
                                               <span class="checkmark"></span>
                                           </label>
                                       </li>
                                       <li>
                                           <label class="chbox2q2">Riga Airport
                                               <input type="checkbox">
                                               <span class="checkmark"></span>
                                           </label>
                                       </li>
                                       <li>
                                           <label class="chbox2q2">Warsaw Airport
                                               <input type="checkbox">
                                               <span class="checkmark"></span>
                                           </label>
                                       </li>
                               ...
                               <div class="filter_type">
                                   ...
                                   <ul>
                                       <li>
                                           <label class="chbox2q2">Superb 9+
                                               <input type="checkbox">
                                               <span class="checkmark"></span>
                                           </label>
                                       </li>
                                       <li>
                                           <label class="chbox2q2">Very Good 8+
                                               <input type="checkbox">
                                               <span class="checkmark"></span>
                                           </label>
                                       </li>
                                       <li>
                                           <label class="chbox2q2">Good 7+
                                               <input type="checkbox">
                                               <span class="checkmark"></span>
                                           </label>
                                       </li>
                                       <li>
                                           <label class="chbox2q2">Pleasant 6+
                                               <input type="checkbox">
                                               <span class="checkmark"></span>
                                           </label>
                                       </li>
                        ...
                        <div class="resize-sensor"
                            ...
                            <div class="resize-sensor-expand"
                                ...
                                <div
                                    style="position: absolute; left: 0px; top: 0px; transition: all 0s ease 0s; width: 550px; height: 98px;">
                                </div>
                            </div>
