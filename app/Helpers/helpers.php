...
function get_room_price($trip,$room_id,$traveler,$start,$end,$type=''){
    ...
    $q=$trip->room_pricing()->whereDate('room_pricing_ranges.end_date','=', $end)->whereDate('room_pricing_ranges.start_date','=',$start);
    $prices_ranges=$q->get();
//    dd([$prices_ranges,$q->toSql(),$q->getBindings()]);
    $prices=[];
    $no_acc_prices=[];
