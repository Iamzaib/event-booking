...
class PackageAmenitiesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.packageAmenities.index', compact('packageAmenities'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.packageAmenities.create');
    }
    ...
    public function store(StorePackageAmenityRequest $request)
    {
        ...
        return redirect()->route('admin.package-amenities.index');
    }
    ...
    public function edit(PackageAmenity $packageAmenity)
    {
        ...
        return view('admin.packageAmenities.edit', compact('packageAmenity'));
    }
    ...
    public function show(PackageAmenity $packageAmenity)
    {
        ...
        return view('admin.packageAmenities.show', compact('packageAmenity'));
    }
