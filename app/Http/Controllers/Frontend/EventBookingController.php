...
class EventBookingController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.eventBookings.index', compact('eventBookings'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.eventBookings.create', compact('booking_by_users', 'booking_events'));
    }
    ...
    public function store(StoreEventBookingRequest $request)
    {
        ...
        return redirect()->route('frontend.event-bookings.index');
    }
    ...
    public function edit(EventBooking $eventBooking)
    {
        ...
        return view('frontend.eventBookings.edit', compact('booking_by_users', 'booking_events', 'eventBooking'));
    }
    ...
    public function show(EventBooking $eventBooking)
    {
        ...
        return view('frontend.eventBookings.show', compact('eventBooking'));
    }
