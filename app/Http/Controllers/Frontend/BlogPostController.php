...
class BlogPostController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.blogPosts.index', compact('blogPosts'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.blogPosts.create', compact('categories', 'tags'));
    }
    ...
    public function store(StoreBlogPostRequest $request)
    {
        ...
        return redirect()->route('frontend.blog-posts.index');
    }
    ...
    public function edit(BlogPost $blogPost)
    {
        ...
        return view('frontend.blogPosts.edit', compact('blogPost', 'categories', 'tags'));
    }
