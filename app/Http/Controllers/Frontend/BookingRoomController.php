...
class BookingRoomController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.bookingRooms.index', compact('bookingRooms'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.bookingRooms.create', compact('booking_fors', 'rooms'));
    }
    ...
    public function store(StoreBookingRoomRequest $request)
    {
        ...
        return redirect()->route('frontend.booking-rooms.index');
    }
    ...
    public function edit(BookingRoom $bookingRoom)
    {
        ...
        return view('frontend.bookingRooms.edit', compact('bookingRoom', 'booking_fors', 'rooms'));
    }
    ...
    public function show(BookingRoom $bookingRoom)
    {
        ...
        return view('frontend.bookingRooms.show', compact('bookingRoom'));
    }
