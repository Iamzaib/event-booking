...
class EventAddonsController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.eventAddons.index', compact('eventAddons'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.eventAddons.create');
    }
    ...
    public function store(StoreEventAddonRequest $request)
    {
        ...
        return redirect()->route('frontend.event-addons.index');
    }
    ...
    public function edit(EventAddon $eventAddon)
    {
        ...
        return view('frontend.eventAddons.edit', compact('eventAddon'));
    }
    ...
    public function show(EventAddon $eventAddon)
    {
        ...
        return view('frontend.eventAddons.show', compact('eventAddon'));
    }
